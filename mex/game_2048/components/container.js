...
class Container extends Component{
  ...
  render() {
    ...
    return (<View {...this._panResponder.panHandlers} style={styles.container} >
                ...
                <View>
                  <TouchableWithoutFeedback onPress={() => _self.saveAndQuit()}>
                    <View style={{backgroundColor: "#bbada0", height: Dimensions.size["10"]}}>
                      <Text style={{textAlign: 'center', color: '#eee4da'}}>Save and Quit</Text>
                    </View>
                  </TouchableWithoutFeedback>
                </View>
  ...
  saveAndQuit() {
    ...
    globalData.RN2048Score = this.score
    CalendarModule.exit()
  }
